...
export default function First(){
    return(
        <div className="">
            ...
            <div className="absolute top-56 left-[500px] text-white font-extrabold text-[30px] flex items-center text-center ">Gym Management system :<br/> DBMS project in MySQL and React</div> 
            <Link to ="/login"><div className="w-52 bg-white h-12 hover:bg-[#3ddd50] absolute top-[400px] left-[650px] rounded-2xl text-center font-semibold  justify-center items-center pt-3">Login to get Started!</div></Link>
        </div>
